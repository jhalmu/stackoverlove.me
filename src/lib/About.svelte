	...
	<div class="card-body">
		...
		<article div class="prose prose-base">
			<p>
				...
				teoreettis-käytänöllinen oppiminen tapahtuu luonnollisesti itseopiskeluna tekemällä
			...
			<p>
				...
				kursseaja, mutta varsinaiset projektit jäivät kolmivuorotyön himmennyksessä. Otin sivuston
			...
			<p>
				Harrastan ja olen harrastanut: valokuvaus, sukututkimus, sijoittaminen, voimailu ja
				opiskelu.
			</p>
			<p>
				Ota yhteyttä esim LinkedIn:in kautta tai laita postia etunimi.sukunimi @iki.fi niin kerron
				mielellään lisää ja katsotaan miten tarpeemme kohtaavat. Sposti löytyy qr-koodin takaa.
			</p>
			<p>
			...
			<p>
				Yritän välttää puhumasta mitä aion tehdä. Sen verran sanon, että nämä sivut ovat kehityksen
				alla.
			</p>
		</article>
